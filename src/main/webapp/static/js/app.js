 ...
 * Java EE Edition (converted from Spring Boot/Thymeleaf)
 * ═══════════════════════════════════════════════════════
 */
...
function statusBadge(status) {
    const map = {
        ...
        'CHECKED_IN': 'badge-checked-in', 'CHECKED_OUT': 'badge-checked-out',
...
function roomTypeBadge(type) {
    const map = {
        'STANDARD': 'badge-room-standard', 'DELUXE': 'badge-room-deluxe',
        'SUITE': 'badge-room-suite', 'PRESIDENTIAL': 'badge-room-presidential',
